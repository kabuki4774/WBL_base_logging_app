 ...
 * Last Revised by nick on 8/9/16
 */
public class MainActivity extends HermesActivity {
    ...
    @Bind(R.id.heartrate_value) TextView mHeartRate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Create the log file.
        FileLog heartRateLog = new FileLog("flexlog.csv");
        heartRateLog.setHeaders("Date", "Time", "Index1, FlexADC1, FlexAngle1, Index1, FlexADC1, FlexAngle1, Index1, FlexADC1, FlexAngle1");

        //FileLog analogLog = new FileLog("demotoday-analog.csv");
        ...
        mDeviceSubscription = dialog.getObservable() // Get the Observable from the device dialog.
                ...
                .subscribe(uartEvent -> {
                    float[] value = uartEvent.data;
                    heartRateLog.write(heartRateLog.date(),heartRateLog.time(),explode(value));
                });
    ...
    protected String explode(float[] array){
        String myine = "";
